...
public class BusquedaResultadoViewModel
{
    ...
    public List<Auka.Application.Entities.Estudiante> Estudiantes { get; set; } = new();
    public List<Auka.Application.Entities.Curso> Cursos { get; set; } = new();
    public List<Auka.Application.Entities.Usuario> Personal { get; set; } = new();
    public List<Auka.Application.Entities.Asignatura> Asignaturas { get; set; } = new();
